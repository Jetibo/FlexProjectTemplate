...
const QueueDirectoryTab = (props: OwnProps) => {
  ...
  const [filteredWorkers, setFilteredWorkers] = useState([] as Array<Worker>); // For testing
  ...
  const filterWorkers = () => {
    ...
    // const updatedWorkersToTest = generateCardComponents(updatedWorkers, isColdTransferEnabled, isWarmTransferEnabled);
    // setFilteredWorkers(updatedWorkersToTest);
    console.log('test 1 WorkerDirectory/updatedWorkers', updatedWorkers);
